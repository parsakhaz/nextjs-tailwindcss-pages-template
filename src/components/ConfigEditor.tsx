...
interface ConfigEditorProps {
	componentId: 'terminal' | 'codeEditor' | 'commandPalette' | 'notificationStack' | 'typewriterMenu' | 'interactiveTypewriter';
}
				...
				{isOpen && (
					...
					>
						<div className='bg-[#1a1a1a] rounded-lg p-4 w-full max-w-2xl'>
							<h3 className='text-white font-semibold mb-4'>Edit {componentId} Configuration</h3>
                    ...
                    focus:outline-none focus:ring-2 focus:ring-white/20'
							...
							<div className='flex justify-end space-x-2 mt-4'>
								<button onClick={() => setIsOpen(false)} className='px-4 py-2 text-white/60 hover:text-white transition-colors'>
									Cancel
								</button>
								<button
									onClick={handleSave}
