		...
		<motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className='space-y-6 text-white'>
				...
				<ol className='list-decimal list-inside space-y-4 text-white/80'>
					<li>
						...
						<div className='mt-2 relative'>
							<pre className='bg-black/20 p-4 rounded-lg'>git clone {repoUrl}</pre>
			...
			<div className='p-4 bg-white/10 rounded-lg'>
				...
				<p className='text-white/80'>
					After installation, visit <code className='bg-black/20 px-2 py-1 rounded'>http://localhost:3000</code> and use the component toggles to enable the components you want to
					record.
				</p>
			</div>
		</motion.div>
