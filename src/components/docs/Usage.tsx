	...
	return (
		<motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className='space-y-6 text-white'>
			...
			<div className='space-y-4'>
				...
				<p className='text-white/80'>Configurations are organized into sections for content, animations, and visual styling. All settings persist in localStorage.</p>
			</div>
			...
			<div className='p-4 bg-white/10 rounded-lg'>
				...
				<p className='text-white/80'>
					For the cleanest key, ensure your recording software is set to capture in the highest quality possible, and use a codec that maintains color accuracy. Take time to
					experiment with component configurations to achieve your desired effect.
				</p>
			</div>
		</motion.div>
	);
